const CACHE='rebate-shell-v1';
const FILES=['./','./index.html','./style.css','./app.mjs','./api.mjs','./ledger.mjs','./history.mjs','./storage.mjs','./install.mjs','./valuation.mjs','./prices.mjs','./extended-api.mjs','./xlayer-api.mjs','./chains.json','./routers.json','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
