...
const files = ['index.html', 'style.css', 'app.mjs', 'api.mjs', 'ledger.mjs', 'valuation.mjs', 'prices.mjs', 'extended-api.mjs', 'xlayer-api.mjs', 'chains.json', 'routers.json','history.mjs','storage.mjs','theme.js','install.mjs','sw.js','manifest.webmanifest','icon-192.png','icon-512.png'];
const assets = {};
